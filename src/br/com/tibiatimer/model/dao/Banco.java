...
import br.com.tibiatimer.model.EnumItem;
...
public class Banco {
	...
	Magic magia1 = new Magic (EnumItem.MAGIC,"Magic Shield", "Todo dano sofrido durante o efeito desta magia será reduzido de sua Mana ao invés de seu HP até ser quebrado "
			+ "com uma certa quantidade de dano recebido.", data.parse("00:03:20"));
	
	
	
	
		Ring ring1 = new Ring (EnumItem.RING,"Energy Ring", "Este item pode ser comercializado pelo Mercado. Provém Magic Shield por 10 minutos. Dessa forma, todo dano recebido durante o efeito deste anel será reduzido de sua mana ao "
	...
	Amulet amulet1 = new Amulet(EnumItem.AMULET,"Bronze Amulet", "Adiciona magic level +3", data.parse("00:03:00"));
